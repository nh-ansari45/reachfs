        ...
        <section className="text-center py-12 px-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-5xl mx-auto">
            ...
            <div className="text-left space-y-4 max-w-xl">
              ...
              <p>Precise seam and other allowances to patterns are critical in garment construction.
</p>
              <p>
                Manually this takes a lot of time and is prone to errors.
A error in this can impact the overall construction of the garment.
              </p>
