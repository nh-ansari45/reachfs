        ...
        <section className="text-center py-12 px-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-5xl mx-auto">
            ...
            <div className="text-left space-y-4 max-w-xl">
              ...
              <p>
                Manual patterns can get worn out and torn and handling is often difficult.
              </p>
              <p>With REACH CAD, you can easily store hundreds or tens of thousands of patterns and related data easily.<br/>
And retrieve these any time, any where.</p>
              <Link
                to="/brochure"
