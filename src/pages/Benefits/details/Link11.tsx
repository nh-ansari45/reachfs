        ...
        <section className="text-center py-12 px-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-5xl mx-auto">
            ...
            <div className="text-left space-y-4 max-w-xl">
              ...
              <p>Manual grading of patterns is laborious and takes many hours of hard work.<br/>
              REACH CAD automates grading saving you a lot of time.</p>
              <p>
                Just think of a situation where you need to create a new garment style that is a slight variation of an existing one.
Manually all patterns have to be created afresh and graded.
              </p>
