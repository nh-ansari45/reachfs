        ...
        <section className="text-center py-12 px-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-5xl mx-auto">
            ...
            <div className="text-left space-y-4 max-w-xl">
              ...
              <p>Errors can creep in when patterns are made manually for many reasons. <br/>
              Manual pattern making process is laborious, repetitive and the most disciplined pattern maker too can slack off at times.</p>
              <p>
              ...
              <p>Not so with REACH CAD.<br/>
With REACH CAD your pattern making process is effortless.<br/>
And even when an error is made unintentionally, you can make corrections in a jiffy.</p>
              <Link
                to="/brochure"
